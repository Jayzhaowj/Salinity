...
######## load OptimalX ########
load(paste0(getwd(), "/results/withSalinity/OptimalX_base_finerS.RData"))
...
save(profit_all, k_min, OptimalX_backup, file = paste0(getwd(), "/results/withSalinity/result_base_finerS.RData"))
