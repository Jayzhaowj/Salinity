...
######## load OptimalX ########
load(paste0(getwd(), "/results/withSalinity/OptimalX_r002_finerS.RData"))
...
hyper_par <- list(x0 = numeric(15), P = rep(0.2, 5), 
                  xLB = numeric(15), R = 0.02, type = type, Cgw = Cgw)
...
save(profit_all, k_min, OptimalX_backup, file = paste0(getwd(), "/results/withSalinity/result_r002_finerS.RData"))