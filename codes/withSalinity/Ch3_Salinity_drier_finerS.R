...
######## load OptimalX ########
load(paste0(getwd(), "/results/withSalinity/OptimalX_drier_finerS.RData"))
########constants##########
...
save(profit_all, k_min, time, OptimalX_backup, file = paste0(getwd(), "/results/withSalinity/result_drier_finerS.RData"))
