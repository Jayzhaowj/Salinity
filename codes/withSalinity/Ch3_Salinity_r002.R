...
######## load OptimalX ########
load(paste0(getwd(), "/results/withSalinity/OptimalX_r002.RData"))
...
save(profit_all, k_min, OptimalX_backup, file = paste0(getwd(), "/results/withSalinity/result_r002.RData"))